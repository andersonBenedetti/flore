...
<main id="pg-home" role="main">
    ...
    <section class="section-format">
        <div class="format-intro">
            <h2>Todos os formatos</h2>
            <div class="swiper-pagination" id="pagination-format"></div>
            <div class="swiper-button-prev"></div>
            <div class="swiper-button-next"></div>
        </div>

        <div class="format-carousel swiper">
            <div class="swiper-wrapper">
                <?php foreach ($formats as $format): ?>
                    <div class="swiper-slide">
                        <a href="<?php echo esc_url($format['url']); ?>">
                            <img src="<?php echo esc_url($format['img']); ?>"
                                alt="<?php echo esc_attr($format['label']); ?>">
    ...
    <section class="section-creative">
        ...
        <div class="btn-creative">
            <div class="container">
                <a class="btn" href="#">Seja um parceiro</a>
            </div>
        </div>
